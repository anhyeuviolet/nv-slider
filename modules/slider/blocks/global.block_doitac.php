...
if( ! nv_function_exists( 'nv_block_doitac' ) )
{
	...
	function nv_block_doitac( $block_config )
	{
		...
		if( ! empty( $list ) )
		{
			if( file_exists( NV_ROOTDIR . '/themes/' . $module_info['template'] . '/modules/slider/block_doitac.tpl' ) )
			{
			...
			$xtpl = new XTemplate( 'block_doitac.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/slider' );
